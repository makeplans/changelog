...
* All third party newsletter subscriptions now require concent from the customer. Automatically added when using the standard booking form but for custom forms use {% raw %}{% opt_in_marketing %}{% endraw %}.
